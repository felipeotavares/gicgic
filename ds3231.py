##codio baseado em https://github.com/balance19/micropython_DS3231
...
class RTC:
    ...
    def DS3231_ReadTime(self, mode=0):
        try:
            ...
            month = self.bcd2bin(buffer[5]& 0x7F)  # Just put the month value in the month variable and convert it.##alterado
